...
public class Weapon : MonoBehaviour
{
	...
	public List<string> bulletHolePoolNames = 
		new List<string>();									// A list of strings holding the names of bullet hole pools in the scene
	...
	void Fire()
	{
		...
		for (int i = 0; i < shotPerRound; i++)
		{
			...
			{
				Debug.DrawRay(raycastStartSpot.position, direction*hit.distance, Color.red, 3);
